...
export const hoaManagementPage: IndustryPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      bgImage: '/images/rrfps-hoa-management-community-property-services.jpg',
      panels: [
        {
      ...
      panels: [
        {
          ...
          image: '/images/rrfps-hoa-management-board-planning-meeting.jpg',
        },
        {
          number: '02',
          ...
          image: '/images/rrfps-hoa-management-fire-sprinkler-budget-planning.jpg',
        },
        {
          number: '03',
          ...
          image: '/images/rrfps-hoa-management-colorado-community-advocacy.jpg',
        },
      ],
    },
    {
      ...
      image: '/images/rrfps-hoa-management-emergency-life-safety-response.jpg',
      imageAlt:
  ...
  cta: {
    backgroundImage: '/images/rrfps-hoa-management-community-fire-protection-cta.jpg',
    paragraphs: [
