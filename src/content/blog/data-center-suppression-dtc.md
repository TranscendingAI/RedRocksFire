...
1. **The fire itself** — usually electrical in origin, starting small in a rack, a power supply, or a cable tray.
2. **The suppression method** — because water on energized, high-value electronics is its own catastrophic-loss event.
3. **Downtime** — every minute a room is offline has a cost, so even a successful suppression that forces a long shutdown is a partial loss.
